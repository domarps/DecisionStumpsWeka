...
public class Id3DecStump4Tester {
	...
	for(int i = 0; i < numFolds ; i++)
	{
		...
		Id3 classifierID3_Stump4 = new Id3();

		// An example depth. If this value is -1, then the tree is grown to full
		// depth.
		classifierID3_Stump4.setMaxDepth(4);

		// Train
		classifierID3_Stump4.buildClassifier(train);

		// Print the classfier
		System.out.println(classifierID3_Stump4);
		System.out.println();

		// Evaluate on the test set
		Evaluation evaluation = new Evaluation(test);
		evaluation.evaluateModel(classifierID3_Stump4, test);
